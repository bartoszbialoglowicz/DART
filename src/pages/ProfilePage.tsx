...
function TrainingSection() {
  ...
  return (
    <section>
      <SectionLabel>Treningi solo</SectionLabel>

      {isLoading ? (
        <p className="text-sm text-content-secondary">Ładowanie...</p>
      ) : sessions.length === 0 ? (
        <EmptyNote>Brak zapisanych sesji. Zagraj mecz w trybie Solo, aby zobaczyć statystyki.</EmptyNote>
      ) : (
        <>
          ...
          <div className="flex flex-col gap-1.5 mt-6">
            {sessions.map(s => (
              ...
              >
                <span className="w-24 shrink-0 text-xs tabular-nums text-content-secondary">
